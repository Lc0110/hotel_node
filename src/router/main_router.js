...
const { verifyMember } = require("../middleware/member.middleware");
...
mainRouter.post("/createmember", mainController.createMember);
mainRouter.post("/login", verifyMember, mainController.login);
mainRouter.post("/edit", mainController.edit);
